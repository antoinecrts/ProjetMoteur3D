...
void GeometricModel::buildSSBO()
{
   ...
   // GLError::enableCallback();
    ...
    if(m_Buffer != NULL) 
		LOG_TRACE << "GEOMETRIC MODEL:GPUbuffer création:"<< "liste triangle melangé"<<"nbr tri:"<<nb_faces << std::endl;
   ...
   // GLError::disableCallback();
    LOG_TRACE <<"GEOMETRIC MODEL:fin de remplissage ssbo" << std::endl;
